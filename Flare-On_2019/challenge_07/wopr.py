"""
Python code copied from memory of worp.exe
"""
import hashlib
import os
import random
...
def wrong():
    ...
    windll.kernel32.LoadLibraryW("wopr")
    trust = windll.kernel32.GetModuleHandleW("wopr")
...
def _wrong():
    ...
    trust = windll.kernel32.GetModuleHandleW("wopr")
    print(hex(trust))
    with open('wopr.exe','rb') as f:
        trust = bytearray(f.read())
...
launch_code = '\x15>-SY\x8388\\m V\x97\x907\xf2'.encode()
launch_code = 'ABCDEF0123456789'.encode()

# encoding map coordinates
x = list(launch_code.ljust(16, b'\0'))
#x = [21, 62, 45, 83, 89, 131, 56, 56, 92, 109, 32, 86, 151, 144, 55, 242]
print("x=",x)
b = 16 * [None]
